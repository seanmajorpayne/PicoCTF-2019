...
I googled the name "la cifre de" to see what came up. The first result is the Vigenère Cypher page.
This is a cypher I've seen before in previous CTFs, so no surprises here.

Connecting to the service sends back
...
```
I tried a few online decrypters, but had the best luck with this one, using the 'classical'
variant of the cypher.
...
This has the flag! picoCTF{b311a50_0r_v1gn3r3_c1ph3r7b996649}
